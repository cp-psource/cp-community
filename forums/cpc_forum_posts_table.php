...
if ($style == 'table'):
    ...
    if ($show_header):
        $html .= '<div class="cpc_forum_posts_header">';

            // Any more column headers? (apply float:right)
            $html = apply_filters( 'cpc_forum_post_columns_header_filter', $html, $term->term_id, $atts );

            $html .= '<div class="cpc_forum_title_header">'.$header_title.'</div>';
            if ($show_freshness) $html .= '<div class="cpc_forum_categories_freshness_header">'.$header_freshness.'</div>';    
            if ($show_last_activity) $html .= '<div class="cpc_forum_last_poster_header">'.$header_last_activity.'</div>';
            if ($show_count) $html .= '<div class="cpc_forum_count_header">'.$header_count.'</div>';
        $html .= '</div>';
    endif;
    ...
    $html .= '<div class="'.$slug.' cpc_forum_posts">';
...
// echo 'new since previous login, so mark as new<br />';
				...
				$forum_html .= '<div class="cpc_forum_post';
                        if ($forum_post['new']) $forum_html .= ' cpc_forum_post_new_table';
					...
					if ($show_last_activity):
						$forum_html .= '<div class="cpc_forum_last_poster">';
						$forum_html .= $author ? $author : '&nbsp;';
						$forum_html .= '</div>';
					endif;
					if ($show_count):
						$forum_html .= '<div class="cpc_forum_count">';
