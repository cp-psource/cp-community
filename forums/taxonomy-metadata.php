<?php
/*
Plugin Based on: Taxonomy Metadata
 ...
 */
function cpc_add_term_meta($term_id, $meta_key, $meta_value, $unique = false) {
 ...
 * @return bool False for failure. True for success.
 */
function cpc_delete_term_meta($term_id, $meta_key, $meta_value = '') {
 ...
 *  is true.
 */
function cpc_get_term_meta($term_id, $key, $single = false) {
 ...
 */
function cpc_update_term_meta($term_id, $meta_key, $meta_value, $prev_value = '') {
