...
sys.path.append(os.path.abspath('./psource_sphinx_theme/'))


#from psource_sphinx_theme import __version__
...
project = u'PSOURCE Sphinx Theme'
copyright = u'PSOURCE'
...
html_theme = 'psource_sphinx_theme'
...
# of the sidebar.
html_logo = "psource_sphinx_theme/static/images/psource-logo-dark.svg"
...
htmlhelp_basename = 'PSOURCESphinxthemedemodoc'
