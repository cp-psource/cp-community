                    ...
                    if (isset($_GET['cpc_reset_options'])) {
                        ...
                        echo '<div id="cpc_admin_getting_started_options_right" style="display: none;">';
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_avatar_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays a user's avatar.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-avatar] to a ClassicPress Page, Post or Text widget.', CPC2_TEXT_DOMAIN);
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_avatar_change_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays the form to let users upload an avatar.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-avatar-change] to a ClassicPress Page, Post or Text widget.', CPC2_TEXT_DOMAIN);
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_avatar_change_link_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays a link to let a user change their avatar.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-avatar-change-link] to a ClassicPress Page, Post or Text widget.', CPC2_TEXT_DOMAIN);
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_forum_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays topics (and replies if style is set to 'classic') of a forum.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.sprintf(__('Add [cpc-forum slug="xxx"] to a ClassicPress Page where "xxx" is the <a href="%s">slug of your forum</a>.', CPC2_TEXT_DOMAIN), admin_url( 'edit-tags.php?taxonomy=cpc_forum&post_type=cpc_forum_post' ));
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_forum_backto_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays a link back to the forum topics. Only shown when viewing a single topic.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.sprintf(__('Add [cpc-forum-backto slug="xxx"] to the ClassicPress Page of your forum (click on the <strong>Page</strong> link <a href="%s">here</a>) where "xxx" is the <a href="%s">slug of your forum</a>.', CPC2_TEXT_DOMAIN), admin_url( 'admin.php?page=cpccom_forum_setup' ), admin_url( 'edit-tags.php?taxonomy=cpc_forum&post_type=cpc_forum_post' ));
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_forum_comment_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays a text area to add a reply to a forum topic. Only shown when viewing a single topic.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.sprintf(__('Add [cpc-forum-reply slug="xxx"] to the ClassicPress Page of your forum (click on the <strong>Page</strong> link <a href="%s">here</a>) where "xxx" is the <a href="%s">slug of your forum</a>.', CPC2_TEXT_DOMAIN), admin_url( 'admin.php?page=cpccom_forum_setup' ), admin_url( 'edit-tags.php?taxonomy=cpc_forum&post_type=cpc_forum_post' ));
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_forum_page_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays a ready made page for a forum.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.sprintf(__('Add [cpc-forum-page slug="xxx"] to a ClassicPress Page where "xxx" is the <a href="%s">slug of your forum</a>.', CPC2_TEXT_DOMAIN), admin_url( 'edit-tags.php?taxonomy=cpc_forum&post_type=cpc_forum_post' ));
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_forum_post_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays a textarea for adding a forum topic.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.sprintf(__('Add [cpc-forum-post slug="xxx"] to a ClassicPress Page where "xxx" is the <a href="%s">slug of your forum</a> or slug="choose" to allow users to select.', CPC2_TEXT_DOMAIN), admin_url( 'edit-tags.php?taxonomy=cpc_forum&post_type=cpc_forum_post' ));
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_forums_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays a top level of all forums.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-forums] to a ClassicPress Page, Post or Text Widget.', CPC2_TEXT_DOMAIN);
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_forum_show_posts_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Flexible way to show forum posts.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.sprintf(__('Add [cpc-forum-show-posts slug="xxx"] to the ClassicPress Page of your forum (click on the <strong>Page</strong> link <a href="%s">here</a>) where "xxx" is the <a href="%s">slug of your forum</a>.', CPC2_TEXT_DOMAIN), admin_url( 'admin.php?page=cpccom_forum_setup' ), admin_url( 'edit-tags.php?taxonomy=cpc_forum&post_type=cpc_forum_post' ));    
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_forum_children_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays child forums as setup in Edit Forum.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.sprintf(__('Add [cpc-forum-children slug="xxx"] to the ClassicPress Page of your forum (click on the <strong>Page</strong> link <a href="%s">here</a>) where "xxx" is the <a href="%s">slug of the parent forum</a>.', CPC2_TEXT_DOMAIN), admin_url( 'admin.php?page=cpccom_forum_setup' ), admin_url( 'edit-tags.php?taxonomy=cpc_forum&post_type=cpc_forum_post' ));    
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_forum_sharethis_insert_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.sprintf(__("Inserts ShareThis code added to <em>any</em> forum <a href='%s'>here</a>.", CPC2_TEXT_DOMAIN), admin_url( 'admin.php?page=cpccom_forum_setup' )).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.sprintf(__('Add [cpc-forum-sharethis slug="xxx"] to a ClassicPress Page where "xxx" is the <a href="%s">slug of your forum</a>.', CPC2_TEXT_DOMAIN), admin_url( 'admin.php?page=cpccom_forum_setup' ));
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_friends_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays a user's friends.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-friends] to a ClassicPress Page, Post or Text widget.', CPC2_TEXT_DOMAIN);
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_friends_status_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays the friendship status of a user with the current user.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-friends-status] to the ClassicPress Page being used as the profile page.', CPC2_TEXT_DOMAIN);
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_friends_pending_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays pending friendship requests for the current user.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-friends-pending] to the ClassicPress Page being used as the profile page.', CPC2_TEXT_DOMAIN);
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_friends_add_button_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays a button to make a request to another user as a friend.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-friends-add-button] to the ClassicPress Page being used as the profile page.', CPC2_TEXT_DOMAIN);
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_friends_count_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays the number of friends (accepted or pending) a user has.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-friends-count] to the ClassicPress Page being used as the profile page.', CPC2_TEXT_DOMAIN);
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_alerts_friends_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays an icon for pending friendship requests.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-alerts-friends] to a ClassicPress Page, Post of Text widget.', CPC2_TEXT_DOMAIN);
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_favourite_friend_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays button/link to add/remove user as a favourite. Also options for the Friends page (which shows favourite profiles at the top).", CPC2_TEXT_DOMAIN).'<br />';
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_usermeta_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays a profile value (meta) of a user, including standard ClassicPress meta values such as display_name.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-usermeta] to a ClassicPress Page, Post of Text widget. Can be added more than once.', CPC2_TEXT_DOMAIN).'<br />';
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_usermeta_button_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays a button to link to a URL, passing the user's ID as a parameter.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-usermeta-button] to a ClassicPress Page.', CPC2_TEXT_DOMAIN);
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_usermeta_change_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays profile fields for the user, which they can edit. This is their Edit Profile page.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-usermeta-change] to a ClassicPress Page.', CPC2_TEXT_DOMAIN).'<br />';
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_usermeta_change_link_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays a link to the Edit Profile page.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-usermeta-change-link] to a ClassicPress Page, Post or Text widget.', CPC2_TEXT_DOMAIN);
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_close_account_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays button for users to close their account.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-close-account] to a ClassicPress Page, Post or Text widget.', CPC2_TEXT_DOMAIN);
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_join_site_tab');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Displays a link or button to join a site (multisite only).", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-join-site] to a ClassicPress Page, Post or Text widget.', CPC2_TEXT_DOMAIN);
                            ...
                            echo cpc_show_options($cpc_expand_shortcode, 'cpc_no_user_check');
                                echo '<strong>'.__('Zweck:', CPC2_TEXT_DOMAIN).'</strong> '.__("Checks for a valid user and displays an option message.", CPC2_TEXT_DOMAIN).'<br />';
                                echo '<strong>'.__('Wie benutzen:', CPC2_TEXT_DOMAIN).'</strong> '.__('Add [cpc-no-user-check] to a ClassicPress Page, Post or Text widget.', CPC2_TEXT_DOMAIN);
