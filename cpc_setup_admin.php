    ...
    function cpc_admin_getting_started_extensions() {
        ...
        <tr class="form-field">
            ...
            <td>
                ...
                $values = $values ? explode(',', $values) : array();
                echo '<p style="font-size:2.0em;">'.__('System', CPC2_TEXT_DOMAIN).'</p>';
                echo cpc_show_core($values, 'core-alerts-customise',   __('Customize Email alerts', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/email-alerts/', '');
                if (strpos(CPC_CORE_PLUGINS, 'core-alerts') === false):
                    echo '<br /><div class="cpc_warning">'.__('Customize Email alerts requires Alerts in core features', CPC2_TEXT_DOMAIN).'</div>';
                endif;
                echo cpc_show_core($values, 'core-login',              __('Login/Redirect, add restrict access to ClassicPress dashboard', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/cpc-login-form/', '');
                echo cpc_show_core($values, 'core-system-messages',    __('System Messages', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/system-messages/', '');

                echo '<p style="margin-top:10px;font-size:2.0em;">'.__('Activity', CPC2_TEXT_DOMAIN).'</p>';
                if (strpos(CPC_CORE_PLUGINS, 'core-activity') !== false):
                    echo cpc_show_core($values, 'core-activity-whoto',     __('Allow users to choose activity recipient(s)', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/choosing-activity-recipients/', '');
                    echo cpc_show_core($values, 'core-crowds',             __('Let users create activity share lists (requires above to be activated)', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/activity-share-lists/', '');
                    echo cpc_show_core($values, 'core-attachments',        __('Add images to activity posts', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/activity-attachments/', '');
                    echo cpc_show_core($values, 'core-soundcloud',         __('Automatically show Soundcloud on activity', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/activity-attachments/', '');
                    echo cpc_show_core($values, 'core-youtube',            __('Automatically show YouTube videos when URL included', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/activity-attachments/', '');
                    echo cpc_show_core($values, 'core-remote',             __('Automatically show website link previews', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/activity-attachments/', '');
                    echo cpc_show_core($values, 'core-likes',              __('Allow users to like/dislike activity posts and replies', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/likes-and-dislikes/', '');
                    echo cpc_show_core($values, 'core-favourites',         __('Let members keep track of favorite activity posts', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/favorite-activity/', '');
                    echo cpc_show_core($values, 'core-activity-facebook',  __('Allow sharing of activity posts to Facebook', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/activity-to-facebook/', '');
                else:
                    echo '<p class="cpc_warning">'.__('Requires Activity in core features', CPC2_TEXT_DOMAIN).'</div>';
                endif;

                echo '<p style="margin-top:10px;font-size:2.0em;">'.__('Members', CPC2_TEXT_DOMAIN).'</p>';
                if (strpos(CPC_CORE_PLUGINS, 'core-profile') !== false):
                    echo cpc_show_core($values, 'core-extended',           __('Add custom profile extensions', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/profile-extensions/', 'https://cp-community.n3rds.work/user-profile-extensions-videos/');
                    echo cpc_show_core($values, 'core-security',           __('Allow members to personalise profile security', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/profile-security/', '');
                    echo cpc_show_core($values, 'core-directory',          __('Display a directory of members', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/member-directory/', '');
                    echo cpc_show_core($values, 'core-default-friends',    __('Set default friends when a user joins', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/default-friends/', '');
                    echo cpc_show_core($values, 'core-rewards',            __('Reward users with points for actions taken', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/user-rewards/', 'https://cp-community.n3rds.work/the-rewards-extension-video/');
                    echo cpc_show_core($values, 'core-gallery',            __('Allow users to add image galleries', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/image-galleries/', '');
                    echo cpc_show_core($values, 'core-tags',               __('Convert user @tags (user logins) in activity/forums. User selector pop-up not compatible with forum WYSIWYG toolbar.', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/user-tags/', '');
                    echo cpc_show_core($values, 'core-reviews',            __('Reviews of users.', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/cpc-reviews/', '');
                else:
                    echo '<p class="cpc_warning">'.__('Requires Profile in core features', CPC2_TEXT_DOMAIN).'</div>';
                endif;

                echo '<p style="margin-top:10px;font-size:2.0em;">'.__('Forum', CPC2_TEXT_DOMAIN).'</p>';
                if (strpos(CPC_CORE_PLUGINS, 'core-forums') !== false):
                    echo cpc_show_core($values, 'core-forum-attachments',      __('Allow image and document attachments', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/image-and-document-attachments-forum/', '');
                    echo cpc_show_core($values, 'core-forum-extended',         __('Set custom fields for new forum posts', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/custom-forum-fields-forum-extensions/', '');
                    echo cpc_show_core($values, 'core-forum-reply-extended',   __('Set custom fields for forum replies', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/custom-forum-fields-forum-extensions/', '');
                    echo cpc_show_core($values, 'core-forum-search',           __('Add a forum search', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/forum-search/', '');
                    echo cpc_show_core($values, 'core-forum-security',         __('Fine tune access and permissions for forums', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/forum-security/', '');
                    echo cpc_show_core($values, 'core-forum-signature',        __('Let members add a personalised forum signature (via Edit Profile)', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/forum-user-signatures/', '');
                    echo cpc_show_core($values, 'core-forum-subs',             __('Email subscriptions for forum posts and replies', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/forum-subscriptions/', '');
                    echo cpc_show_core($values, 'core-forum-to-activity',      __('Send forum posts and replies to profile activity', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/forum-posts-replies-to-activity-stream/', '');
                    echo cpc_show_core($values, 'core-forum-toolbar',          __('Add a WYSIWYG toolbar to the forum editor', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/forum-toolbar/', '');
                    echo cpc_show_core($values, 'core-forum-youtube',          __('Automatically show YouTube videos when URL included', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/forum-youtube-videos/', '');
                    echo cpc_show_core($values, 'core-forum-likes',            __('Allow users to like/dislike forum replies', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/forum-likesdislikes/', '');
                    echo cpc_show_core($values, 'core-forum-answer',           __('Allow users to mark a forum reply as an answer', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/forum-answers/', '');
                else:
                    echo '<p class="cpc_warning">'.__('Requires Forums in core features', CPC2_TEXT_DOMAIN).'</div>';
                endif;

                echo '<p style="margin-top:10px;font-size:2.0em;">'.__('Groups', CPC2_TEXT_DOMAIN).'</p>';
                if (strpos(CPC_CORE_PLUGINS, 'core-profile') !== false):
                    echo cpc_show_core($values, 'core-groups',             __('Allow members to create groups for group activity', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/group-and-groups/', '');
                    echo cpc_show_core($values, 'core-default-groups',     __('Set default group membership for new users', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/default-groups/', '');
                else:
                    echo '<p class="cpc_warning">'.__('Requires Profile in core features', CPC2_TEXT_DOMAIN).'</div>';
                endif;
        
                echo '<p style="margin-top:10px;font-size:2.0em;">'.__('Private Messages', CPC2_TEXT_DOMAIN).'</p>';
                if (strpos(CPC_CORE_PLUGINS, 'core-profile') !== false):        
                    echo cpc_show_core($values, 'core-mail',               __('Private messages between one or more recipients', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/private-messages-mail/', '');
                    echo cpc_show_core($values, 'core-mail-attachments',   __('Allow mail attachments', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/private-message-attachments/', '');
                    echo cpc_show_core($values, 'core-mail-youtube',       __('Automatically show YouTube videos when URL included', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/private-message-attachments/', '');
                    echo cpc_show_core($values, 'core-mail-subs',          __('Setup email alerts for new mail and replies', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/private-message-email-alerts/', '');
                    echo cpc_show_core($values, 'core-menu-alerts',        __('Show unread mail count in menu (requires change to menu item, click on help icon!)', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/menu-alerts/', '');
                else:
                    echo '<p class="cpc_warning">'.__('Requires Profile in core features', CPC2_TEXT_DOMAIN).'</div>';
                endif;
        
                echo '<p style="margin-top:10px;font-size:2.0em;">'.__('Miscellaneous', CPC2_TEXT_DOMAIN).'</p>';
                echo cpc_show_core($values, 'core-lounge',             sprintf(__('A site-wide chat area ("Lounge") for all members (unsupported feature), we recommend <a href="%s" target="_new">Simple Ajax Chat</a>', CPC2_TEXT_DOMAIN), 'https://wordpress.org/plugins/simple-ajax-chat/'), '', '');
                echo cpc_show_core($values, 'core-calendar',           __('Display calendars on your site', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/calendar-for-site/', '');
                echo cpc_show_core($values, 'core-show-posts',         __('Show blog posts, activity, mail, forum activity - amazingly powerful!', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/cpc-show-posts/', '');
                echo cpc_show_core($values, 'core-migrate',            __('CP Community forum migration tool', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/migrating-from-cp-community-to-cp-community/', '');
                echo cpc_show_core($values, 'core-migrate-bbpress',    __('BBpress forum migration tool', CPC2_TEXT_DOMAIN), 'https://cp-community.n3rds.work/migrating-from-bbpress-to-cp-community/', '');
                ?>
            </td>
        </tr> 
        </table>
