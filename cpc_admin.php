...
function cpc_com_translations() {
	...
	if (current_user_can('manage_options')):
  	...
  	echo '<div class="wrap">';
		...
		echo '<p>'.sprintf(__('Sie müssen mit PoEdit eine .mo-Datei generieren, die auf heruntergeladenen .po-Dateien von <a href="%s" target="_blank">CrowdIn.Net</a> basiert, die Sie Ihren Benutzern anbieten (oder eine wie oben beschrieben erstellen). mit einer Anwendung wie PoEdit) wäre cp-community-fr_FR.mo beispielsweise die .mo-Datei für Französisch. Sie legen die .mo-Dateien im „Übersetzungsordner“ ab, wie im nächsten Abschnitt unten auf dieser Seite gezeigt. Lese mehr darüber im <a href="%s" target="_blank">CP Community Codex</a>.', CPC2_TEXT_DOMAIN), "https://crowdin.com/project/community", "https://cp-community.n3rds.work/translating-cp-community/").'</p>';
